...
var calc = function (input_neuron_values, weight, threshold) {
    ...
    var sum = input_neuron_values.map(function (num) { return num * weight; }).reduce(function (now_sum, num) { return now_sum + num; });
    /* 出力層のニューロンの値を算出 */
...
/* ある2つの単層パーセプトロンの出力を、別の単層パーセプトロンの入力に用いるなど。 */
